					...
					<div class="col-md-4">
						<div class="panel panel-default">
							<div class="panel-heading">
								<small>Grafik Pelanggan yang menggunakan ODP jenis fca</small> 
							</div>
							<div class="panel-body">
										...
										<script type="text/javascript">
												Morris.Donut({
												  element: 'morris-donut-chart',
													...
													$p1   = mysql_query("SELECT * FROM data_pelanggan WHERE dp_jenisODP='FCA' and dp_jenisLayanan='1P'");
													$p2   = mysql_query("SELECT * FROM data_pelanggan WHERE dp_jenisODP='FCA' and dp_jenisLayanan='2P'");
													$p3   = mysql_query("SELECT * FROM data_pelanggan WHERE dp_jenisODP='FCA' and dp_jenisLayanan='3P'");
						...
						<div class="panel panel-default">
							...
							<div class="panel-footer">
								<div class="btn-group btn-group-justified" role="group" aria-label="...">
									...
									<div class="btn-group" role="group">
										<a href="fca.php"><button type="button" class="btn btn-info">fca</button></a>
									</div>
								</div>
							</div>
						</div>
			    ...
			    <div class="modal-content">
				    ...
				    <div class="modal-body">
						<table class="table table-striped table-bordered table-hover" id="dataTables-example">
							...
							<tbody>
								<?php
								$query = mysql_query("SELECT * FROM data_pelanggan where dp_jenisODP='fca' and dp_jenisLayanan='1P' ORDER BY dp_nomor") or die(mysql_error());
			    ...
			    <div class="modal-content">
				    ...
				    <div class="modal-body">
						<table class="table table-striped table-bordered table-hover" id="dataTables-example">
							...
							<tbody>
								<?php
								$query = mysql_query("SELECT * FROM data_pelanggan where dp_jenisODP='fca' and dp_jenisLayanan='2P' ORDER BY dp_nomor") or die(mysql_error());
			    ...
			    <div class="modal-content">
				    ...
				    <div class="modal-body">
						<table class="table table-striped table-bordered table-hover" id="dataTables-example">
							...
							<tbody>
								<?php
								$query = mysql_query("SELECT * FROM data_pelanggan where dp_jenisODP='fca' and dp_jenisLayanan='3P' ORDER BY dp_nomor") or die(mysql_error());
