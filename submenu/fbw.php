					...
					<div class="col-md-4">
						<div class="panel panel-default">
							<div class="panel-heading">
								<small>Grafik Pelanggan yang menggunakan ODP jenis fbw</small> 
							</div>
							<div class="panel-body">
										...
										<script type="text/javascript">
												Morris.Donut({
												  element: 'morris-donut-chart',
													...
													$p1   = mysql_query("SELECT * FROM data_pelanggan WHERE dp_jenisODP='FBW' and dp_jenisLayanan='1P'");
													$p2   = mysql_query("SELECT * FROM data_pelanggan WHERE dp_jenisODP='FBW' and dp_jenisLayanan='2P'");
													$p3   = mysql_query("SELECT * FROM data_pelanggan WHERE dp_jenisODP='FBW' and dp_jenisLayanan='3P'");
					...
					<div class="col-xs-12 col-md-8">
						<div class="panel panel-default">
							...
							<div class="panel-footer">
								<div class="btn-group btn-group-justified" role="group" aria-label="...">
									<div class="btn-group" role="group">
										<a href="fbw.php"><button type="button" class="btn btn-info">fbw</button></a>
									</div>
									<div class="btn-group" role="group">
			    ...
			    <div class="modal-content">
				    ...
				    <div class="modal-body">
						<table class="table table-striped table-bordered table-hover" id="dataTables-example">
							...
							<tbody>
								<?php
								$query = mysql_query("SELECT * FROM data_pelanggan where dp_jenisODP='fbw' and dp_jenisLayanan='1P' ORDER BY dp_nomor") or die(mysql_error());
			    ...
			    <div class="modal-content">
				    ...
				    <div class="modal-body">
						<table class="table table-striped table-bordered table-hover" id="dataTables-example">
							...
							<tbody>
								<?php
								$query = mysql_query("SELECT * FROM data_pelanggan where dp_jenisODP='fbw' and dp_jenisLayanan='2P' ORDER BY dp_nomor") or die(mysql_error());
			    ...
			    <div class="modal-content">
				    ...
				    <div class="modal-body">
						<table class="table table-striped table-bordered table-hover" id="dataTables-example">
							...
							<tbody>
								<?php
								$query = mysql_query("SELECT * FROM data_pelanggan where dp_jenisODP='fbw' and dp_jenisLayanan='3P' ORDER BY dp_nomor") or die(mysql_error());
